...
public class Driver  implements java.io.Serializable {
	...
	public String toString() {
		return "Driver [age=" + age + ", creditScore=" + creditScore + ", dlNumber=" + dlNumber + ", driverName="
				+ driverName + ", numberOfAccidents=" + numberOfAccidents + ", numberOfTickets=" + numberOfTickets
				+ ", ssn=" + ssn + "]";
	}
}